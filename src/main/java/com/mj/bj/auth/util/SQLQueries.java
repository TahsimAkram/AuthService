...
//	
////	public final static String FIND_USER_USING_USERNAME = "SELECT u.user_id ,u.organizationid ,u.usertypeid ,u.roleid ,u.salutation ,"
////			+ "u.firstname ,u.lastname ,u.email ,u.statuscode"
////			+ " ,u.createid ,u.createdate ,u.updateid ,u.updatedate, u.sourceorg ,u.branch ,u.phone ,u.mobile ,u.fax ,u.address ,u.userplatform "
////			+ "FROM eps.user u WHERE u.user_id = ? ";
//	
